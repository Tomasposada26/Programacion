...
const InstagramAccountsTable = ({ accounts, onUnlink, onRefresh, onToggleAutoRefresh, search, setSearch }) => (
  ...
  <div className="instagram-accounts-table-wrapper" style={{ maxHeight: 400, overflowY: 'auto', overflowX: 'hidden', borderRadius: 12, boxShadow: '0 2px 8px #cfd8dc22', width: 1700, minWidth: 1200, margin: '0 auto' }}>
